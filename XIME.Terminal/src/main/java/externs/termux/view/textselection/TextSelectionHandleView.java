package externs.termux.view.textselection;
...
import externs.termux.view.TerminalView;
import externs.termux.view.support.PopupWindowCompatGingerbread;
...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(TerminalView terminalView, CursorController cursorController, int initialOrientation) {
        ...
        mHandleLeftDrawable = getContext().getDrawable(xime.terminal.R.drawable.text_select_handle_left_material);
        mHandleRightDrawable = getContext().getDrawable(xime.terminal.R.drawable.text_select_handle_right_material);
