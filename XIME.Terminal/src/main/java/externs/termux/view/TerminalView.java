...
import externs.termux.terminal.KeyHandler;
import externs.termux.terminal.TerminalEmulator;
import externs.termux.terminal.TerminalSession;
import externs.termux.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public TerminalView(Context context, AttributeSet attributes) { // NO_UCD (unused code)
        ...
        // Ensure default TerminalRenderer is initialized so font metrics are available immediately
        int defaultTextSize = (int) (12 * context.getResources().getDisplayMetrics().density);
        mRenderer = new TerminalRenderer(defaultTextSize > 0 ? defaultTextSize : 24, Typeface.MONOSPACE);
     ...
     * {@link externs.termux.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity externs.termux.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
