...
The full text of the Apache License, Version 2.0 follows in §4 below.
Use `SPDX-License-Identifier: Apache-2.0` in new first-party files.
...
Because GPLv2 binaries are distributed as part of this module, **any app that
includes `XIME.Terminal` is a GPL-covered combined work**: you must comply with
GPLv2 (provide corresponding source, preserve notices, license the combined
work accordingly). Closed-source distribution is **not** permitted with this
module included. This is the sole XIME module with copyleft obligations.

`XIME.Terminal` also contains code derived from
...
| e2fsprogs `lib/support` (dict) | Kaz Kylheku permissive | Permissive |
...
## 3. Practical consequences for consumers

- **Open- or closed-source apps** may use every XIME module **except**
  `XIME.Terminal` under permissive terms (attribution + license preservation).
- **Apps including `XIME.Terminal`** must comply with GPLv2 for the combined work.
- Example: MOVA (closed-source) links `XIME.Core`, `XIME.UI`, `XIME.Animation`,
  `XIME.Haptic`, `XIME.Graphics`, and `XIME.Persistence`, and deliberately
  excludes `XIME.Terminal` and `XIME.Tools`.

---

## 4. Apache License, Version 2.0 (full text)
...
```
   ...
   APPENDIX: How to apply the Apache License to your work.
      ...
      for your intended use from the appropriate open source office.
