...
public class RelativeLayout extends android.widget.RelativeLayout {
    ...
    public RelativeLayout(@NonNull Context context) {
        super(context);
        init(context, null, 0);
    }

    public RelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public RelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
